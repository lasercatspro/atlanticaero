    ...
    <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-24">
      <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
        <div className="space-y-5 sm:space-y-4">
          <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">{RichText.asText(title)}</h2>
              ...
              <li className="sm:py-8">
                <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                  <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                    <img className="object-cover rounded-lg shadow-lg" src={who.primary.image.url} alt={who.primary.image.alt ? who.primary.image.alt : "Pablo Bell"} />
                  </div>
                  <div className="sm:col-span-2">
                    <div className="space-y-4">
                      <div className="space-y-1 text-lg font-medium leading-6">
                        <h3>{who.primary.name}</h3>
                        <p className="text-indigo-600">{who.primary.role}</p>
                      </div>
                      <div className="text-lg">
                        <p className="text-gray-500">{RichText.asText(who.primary.bio)}</p>
                      </div>
