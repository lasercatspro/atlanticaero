                              ...
                              <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                <div className="relative grid gap-6 px-5 py-6 bg-white sm:gap-8 sm:p-8">
                                  {navigationSecond && navigationSecond.map((item) => (
                                    <Link className="block p-3 -m-3 text-base font-medium text-gray-500 rounded-md hover:text-gray-900" key={item.name} href={item.href}>
                                      {item.name}
                                    </Link>
                                  ))}
                                </div>
                ...
                <div className="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
                  ...
                  <div className="px-5 py-6 space-y-6">
                    <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                      ...
                      {navigationMain && navigationMain.map(item =>
                        <Popover.Button className="text-left" key={item.name}>
                          <Link className="text-base font-medium text-gray-500 hover:text-gray-900" href={item.href}>
                            {item.name}
                          </Link>
                        </Popover.Button>)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Link className="inline-flex items-center justify-center px-4 py-2 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm whitespace-nowrap hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="https://bocageairlines.sumup.link/">
